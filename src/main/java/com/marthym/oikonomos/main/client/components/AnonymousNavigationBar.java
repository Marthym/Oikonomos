...
import com.marthym.oikonomos.main.client.resources.AnonymousNavigationBarRessource;
...
public class AnonymousNavigationBar extends Composite {
	...
	private static AnonymousNavigationBarUiBinder uiBinder = GWT.create(AnonymousNavigationBarUiBinder.class);
